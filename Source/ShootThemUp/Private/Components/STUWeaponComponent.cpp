...
{
    UE_LOG(LogWeaponComponent, Display, TEXT("ON RELOAD FINISHED"));
...
{
    UE_LOG(LogWeaponComponent, Display, TEXT("Try to START FIRE1"));
    if (!CanFire()) return;
    UE_LOG(LogWeaponComponent, Display, TEXT("Try to START FIRE2"));
